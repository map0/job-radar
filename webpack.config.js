...
/*
  postCSS loader which gets fed into the next loader. setting it up in it's own variable because its a didgeridog
*/
const postcss = {
...
const styles = {
  ...
  // above we used an object for each loader instead of just a string
...
const config = {
  entry: {
    ...
    App: './public/javascript/jobradar-app.js'
  },
