...
var defaultLat = 42.6648323;
var defafultLng = 23.26632;
...
function loadPlaces(map) {
  ...
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defafultLng;

  _axios2.default.get('/api/jobPosts/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
